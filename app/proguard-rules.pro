...
#下面中括号的地方需要要填你的包名
-keep public class [com.inveno.xiandu].R$*{
...
-keep class com.tencentIM.** { *; }
-dontwarn com.tencentIM.**
-keep enum com.tencentIM.manager.**
-keep interface com.tencentIM.**

-keep class com.imkit.** { *; }
-dontwarn com.imkit.**
-keep enum com.imkit.**
-keep interface com.imkit.**

-keep class com.storemanagement.** { *; }
-dontwarn com.storemanagement.**
-keep enum com.storemanagement.**

-keep class com.activity.** { *; }

-keep class cn.bingoogolapple.qrcode.core.** { *; }
-dontwarn cn.bingoogolapple.qrcode.core.**
-keep enum cn.bingoogolapple.qrcode.core.**
-keep interface cn.bingoogolapple.qrcode.core.**

-keep class com.phonegap.plugins.barcodescanner.** { *; }

-keep class zxing.** { *; }
-dontwarn zxing.**
-keep enum zxing.**

-keep class com.bdplayer.info.**{*;}
-keep class com.richeditor.knowledge.**{*;}
-ignorewarnings
