 ...
 * 男生/女生
 */
public class AdFootTraceLImgRTxtHolder extends NormalAdViewHolder {

    public static NormalAdViewHolder create(Context context) {
        return new AdFootTraceLImgRTxtHolder(View.inflate(context, R.layout.ad_bookshelf_l_img_r_text_layout,null));
    }

    public AdFootTraceLImgRTxtHolder(View itemView) {
        super(itemView);
