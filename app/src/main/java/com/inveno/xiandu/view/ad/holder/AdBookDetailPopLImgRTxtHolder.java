 ...
 * 男生/女生
 */
public class AdBookDetailPopLImgRTxtHolder extends NormalAdViewHolder {

    public static NormalAdViewHolder create(Context context) {
        return new AdBookDetailPopLImgRTxtHolder(View.inflate(context, R.layout.ad_bookdetail_pop_rtxt_limg, null));
    }

    public AdBookDetailPopLImgRTxtHolder(View itemView) {
        super(itemView);
...
//        tv_ad_desc = itemView.findViewById(R.id.tv_ad_desc);
        holderViewType = AD_BOOK_DETAIL_POP_TYPE;
    }
