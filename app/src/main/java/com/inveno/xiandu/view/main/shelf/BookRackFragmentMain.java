 ...
 * Des 书架界面
 */
public class BookRackFragmentMain extends BaseFragment {
    ...
    public ViewGroup initView() {
        ...
        ViewGroup inflate = (ViewGroup) LayoutInflater.from(getContext()).inflate(R.layout.fragment_bookrack_main, null);
