...
import static com.inveno.xiandu.view.read.setting.ReadSettingManager.SHARED_READ_CONVERT_TYPE;
...
public class StringUtils {
    ...
    public static String convertCC(String input, Context context)
    {
        ...
        int convertType = SPUtils.getInformain(SHARED_READ_CONVERT_TYPE, 0);
